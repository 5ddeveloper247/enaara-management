(function () {
    ...
    var INTERNAL_COLUMNS = [
        ...
        /* 77 */ { header: 'Has Certificates',       key: 'has_certificates' },
        /* 78 */ { header: 'Employee CNIC (Front)',            key: 'has_cnic_front' },
        /* 79 */ { header: 'Employee CNIC (Back)',             key: 'has_cnic_back' },
        /* 80 */ { header: "Father's CNIC",                   key: 'has_father_cnic' },
        /* 81 */ { header: 'NOK CNIC',                        key: 'has_nok_cnic' },
        /* 82 */ { header: 'CV / Resume',                     key: 'has_cv_resume' },
        /* 83 */ { header: 'Offer / Appointment Letter',      key: 'has_offer_letter' },
        /* 84 */ { header: 'Police Verification Letter',      key: 'has_police_verification' },
        /* 85 */ { header: 'Probation Evaluation Report',     key: 'has_probation_report' },
        /* 86 */ { header: 'Consultancy Agreement/Contract',  key: 'has_consultancy_agreement' },
        /* 87 */ { header: 'Parent/Guardian Consent Form',    key: 'has_guardian_consent' },
        /* 88 */ { header: 'Discharge/Retirement Order',      key: 'has_discharge_order' },
        /* 89 */ { header: 'Family Registration Certificate', key: 'has_family_certificate' },
        /* 90 */ { header: 'Academic Transcript',             key: 'has_academic_transcript' },
        /* 91 */ { header: 'Academic Degree',                 key: 'has_academic_degree' },
        /* 92 */ { header: 'Professional Certificate',        key: 'has_professional_cert' },
        /* 93 */ { header: 'Experience Letter',               key: 'has_experience_letter' },
        /* 94 */ { header: 'Salary Slip',                     key: 'has_salary_slip' },
        /* 95 */ { header: 'Medical Report/Certificate',      key: 'has_medical_report' },
        /* 96 */ { header: 'Previous Organization',  key: 'last_organization' },
        /* 97 */ { header: 'Previous Monthly Salary',key: 'last_salary' },
        /* 98 */ { header: 'Disability',             key: 'has_disability' },
        /* 99 */ { header: 'Disability Type',        key: 'disability_type' },
        /* 100 */ { header: 'Chronic Disease',        key: 'has_chronic_disease' },
        /* 101 */ { header: 'Reference Name',        key: 'ref_name' },
        /* 102 */ { header: 'Reference Contact',     key: 'ref_contact' },
        /* 103 */ { header: 'Employment Type',       key: 'employment_type' },
        /* 104 */ { header: 'Employee Type',         key: 'employee_type' }
    ];
