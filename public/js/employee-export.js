(function () {
    ...
    var INTERNAL_COLUMNS = [
        ...
        /* 43 */ { header: 'Hybrid On-site Days',    key: 'hybrid_days' },
        /* 44 */ { header: 'Hybrid Off-site Days',   key: 'hybrid_offsite_days' },
        /* 45 */ { header: 'TAS ID',                 key: 'biometric_id' },
        ...
        /* 68 */ { header: 'Spouse',                 key: 'spouse_count' },
        /* 69 */ { header: 'Kids',                   key: 'kids_count' },
        /* 70 */ { header: 'Son',                    key: 'son_count' },
        /* 71 */ { header: 'Daughter',               key: 'daughter_count' },
        /* 71 */ { header: 'NOK Name',               key: 'nok_name' },
        /* 72 */ { header: 'NOK Relation',           key: 'nok_relation' },
        /* 73 */ { header: 'NOK CNIC',               key: 'nok_cnic' },
        /* 74 */ { header: 'Academic Qualification', key: 'latest_degree' },
        /* 75 */ { header: 'Degree Title',           key: 'latest_degree_title' },
        /* 76 */ { header: 'Institute',              key: 'latest_institute' },
        /* 77 */ { header: 'Professional / Tech Certification', key: 'latest_certificate_name' },
        /* 78 */ { header: 'Institute',              key: 'latest_certificate_institute' },
        /* 79 */ { header: 'Has Certificates',       key: 'has_certificates' },
        /* 80 */ { header: 'Employee CNIC (Front)',            key: 'has_cnic_front' },
        /* 81 */ { header: 'Employee CNIC (Back)',             key: 'has_cnic_back' },
        /* 82 */ { header: "Father's CNIC",                   key: 'has_father_cnic' },
        /* 83 */ { header: 'NOK CNIC',                        key: 'has_nok_cnic' },
        /* 84 */ { header: 'CV / Resume',                     key: 'has_cv_resume' },
        /* 85 */ { header: 'Offer / Appointment Letter',      key: 'has_offer_letter' },
        /* 86 */ { header: 'Police Verification Letter',      key: 'has_police_verification' },
        /* 87 */ { header: 'Probation Evaluation Report',     key: 'has_probation_report' },
        /* 88 */ { header: 'Consultancy Agreement/Contract',  key: 'has_consultancy_agreement' },
        /* 89 */ { header: 'Parent/Guardian Consent Form',    key: 'has_guardian_consent' },
        /* 90 */ { header: 'Discharge/Retirement Order',      key: 'has_discharge_order' },
        /* 91 */ { header: 'Family Registration Certificate', key: 'has_family_certificate' },
        /* 92 */ { header: 'Academic Transcript',             key: 'has_academic_transcript' },
        /* 93 */ { header: 'Academic Degree',                 key: 'has_academic_degree' },
        /* 94 */ { header: 'Professional Certificate',        key: 'has_professional_cert' },
        /* 95 */ { header: 'Experience Letter',               key: 'has_experience_letter' },
        /* 96 */ { header: 'Salary Slip',                     key: 'has_salary_slip' },
        /* 97 */ { header: 'Medical Report/Certificate',      key: 'has_medical_report' },
        /* 98 */ { header: 'Previous Organization',  key: 'last_organization' },
        /* 99 */ { header: 'Previous Monthly Salary',key: 'last_salary' },
        /* 100 */ { header: 'Disability',             key: 'has_disability' },
        /* 101 */ { header: 'Disability Type',        key: 'disability_type' },
        /* 102 */ { header: 'Chronic Disease',        key: 'has_chronic_disease' },
        /* 103 */ { header: 'Reference Name',        key: 'ref_name' },
        /* 104 */ { header: 'Reference Contact',     key: 'ref_contact' },
        /* 105 */ { header: 'Employment Type',       key: 'employment_type' },
        /* 106 */ { header: 'Employee Type',         key: 'employee_type' }
    ];
