        ...
        try {
            return response()->json([
                ...
                'data'    => $this->employeeService->getTableData([
                    ...
                    'filter_employee_status' => $request->query('filter_employee_status'),
                    'filter_employment_category' => $request->query('filter_employment_category'),
                    'filter_employment_type' => $request->query('filter_employment_type'),
