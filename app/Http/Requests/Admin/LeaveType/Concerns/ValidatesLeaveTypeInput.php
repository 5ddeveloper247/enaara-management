...
trait ValidatesLeaveTypeInput
{
    ...
    protected function leaveTypeRules(?int $ignoreLeaveTypeId = null): array
    {
        ...
        return [
            ...
            'leave_condition' => ['required', 'string', 'in:conditional,unconditional,general'],
    ...
    protected function leaveTypeMessages(): array
    {
        return [
            ...
            'leave_condition.in' => 'Leave type must be Conditional leave, Unconditional leave, or General.',
