...
<div class="step" id="step-4">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="reason_of_retirement" class="form-control">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="ex_army_unit" class="form-control">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="pma_lc_ots" class="form-control">
        </div>
    </div>
</div>
