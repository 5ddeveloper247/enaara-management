...
<head>
  ...
  <title>Shift Roster Approval Required – Enaara HRMS</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <h2>Shift roster approval required</h2>
      <p>Hi <strong>{{ $recipientName }}</strong>,</p>
      <p>A shift roster has been submitted for your approval. Please review the details below.</p>
      <div class="highlight">
        ...
        <div class="info-row"><span class="label">Submitted By</span><span>{{ $requestedByName }}</span></div>
      ...
      <p>Please log in to Enaara HRMS to review and approve this roster.</p>
      <div class="btn-wrap">
        <a href="{{ $actionUrl }}" class="btn">Review &amp; Approve</a>
      </div>
    </div>
    <div class="footer">
