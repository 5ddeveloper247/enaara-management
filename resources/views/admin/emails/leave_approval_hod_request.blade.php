...
<head>
  ...
  <title>Leave Approval Request – Enaara HRMS</title>
  <style>
    ...
    .info-row .label { color: #888888; min-width: 160px; }
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p>A leave request has been recommended by the line manager and is now awaiting your final approval. Please review the details below.</p>
      <div class="highlight">
        ...
        @if($recommendedBy !== 'Pending Review')
          <div class="info-row"><span class="label">Recommended By</span><span>{{ $recommendedBy }}</span></div>
        @endif
      </div>
      <p>Please log in to Enaara HRMS to approve or reject this request.</p>
      <div class="btn-wrap">
        <a href="{{ $actionUrl }}" class="btn">Approve / Reject</a>
      </div>
    </div>
    <div class="footer">
