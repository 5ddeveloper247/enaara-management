...
<head>
  ...
  <title>Shift Roster Approved – Enaara HRMS</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <h2>Shift roster approved</h2>
      <p>Hi <strong>{{ $recipientName }}</strong>,</p>
      <p>Your submitted shift roster has been approved and is now active in the shift planner.</p>
      <div class="highlight">
        <strong>Approved Roster</strong>
        <div class="info-row"><span class="label">Employee</span><span>{{ $assigneeName }}</span></div>
        <div class="info-row"><span class="label">Approved By</span><span>{{ $approverName }}</span></div>
