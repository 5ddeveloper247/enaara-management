...
<head>
  ...
  <title>Leave Submitted – Enaara HRMS</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p>
        An employee from <strong>{{ $departmentName }}</strong> has submitted a leave request.
        Please review the details below for your information.
      </p>
      <div class="highlight">
      ...
      <p>Please log in to Enaara HRMS to view this request.</p>
      <div class="btn-wrap">
        <a href="{{ $actionUrl }}" class="btn">View Leave Request</a>
      </div>
    </div>
    <div class="footer">
