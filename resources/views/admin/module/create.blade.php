...
@section('title', 'Add Module - Admin Panel')
                ...
                <form action="{{ route('admin.module.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="module_name" id="module_name" class="form-control @error('module_name') is-invalid @enderror" value="{{ old('module_name') }}" required maxlength="155">
                            @error('module_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-6">
                            <label for="route" class="form-label">Route</label>
                            <input type="text" name="route" id="route" class="form-control @error('route') is-invalid @enderror" value="{{ old('route') }}" maxlength="155">
                            @error('route')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-6">
                            <label for="css_class" class="form-label">CSS Class</label>
                            <input type="text" name="css_class" id="css_class" class="form-control @error('css_class') is-invalid @enderror" value="{{ old('css_class') }}" maxlength="100">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch mt-2">
                                ...
                                <input type="checkbox" name="show_in_menu" id="show_in_menu" class="form-check-input" value="1" {{ old('show_in_menu', true) ? 'checked' : '' }}>
                                <label class="form-check-label" for="show_in_menu">Yes</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary bg-main border-0">Create Module</button>
