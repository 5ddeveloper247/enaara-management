                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="opacity-75 text-white mb-1 small fw-normal text-uppercase">
                            <i class="bi bi-grid me-1"></i>Total Modules
                        </h6>
                        <div class="h4 mb-0 fw-bold text-white" id="totalModules">{{ $total ?? 0 }}</div>
                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="text-muted mb-1 small fw-normal text-uppercase">
                            <i class="bi bi-check-circle me-1"></i>Show in Menu
                        </h6>
        ...
        <div class="card border-0 rounded-3 shadow h-100">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="text-muted mb-1 small fw-normal text-uppercase">
                            <i class="bi bi-x-circle me-1"></i>Hidden
                        </h6>
