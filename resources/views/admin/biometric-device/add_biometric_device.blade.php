<div class="offcanvas offcanvas-end bg-main text-white" tabindex="-1" id="addBiometricDeviceCanvas"
    ...
    <div class="offcanvas-body">
        <form id="addBiometricDeviceForm" data-store-url="{{ route('admin.biometric-device.store') }}">
            ...
            <div class="mb-3">
                <label for="bd_sbu_floor_id" class="form-label fw-semibold small text-white">Floor <span class="text-danger">*</span></label>
                <select class="form-select" id="bd_sbu_floor_id" name="sbu_floor_id" disabled>
