<div class="offcanvas offcanvas-end bg-main text-white" tabindex="-1" id="addDesignationCanvas"
    ...
    <div class="offcanvas-body">
        <form id="addDesignationForm" data-store-url="{{ route('admin.designations.store') }}" novalidate>
            ...
            <div class="mb-3">
                <label for="ds_department_id" class="form-label fw-semibold small text-white">
                    Department <span class="text-danger">*</span>
                </label>
                <select class="form-select" id="ds_department_id" name="department_id" disabled required>
