                 ...
                 <div class="col-2">
                     <div class="card border-0 shadow-sm bg-light h-100">
                         <div class="card-body p-3 d-flex flex-column align-items-center justify-content-center">
                             ...
                             <div class="position-relative mt-2" style="width: 110px; height: 110px;"
                                 ...
                                 <div class="rounded-circle d-flex align-items-center justify-content-center position-relative overflow-hidden border-2 border-white shadow-sm bg-secondary-subtle text-secondary w-100 h-100"
                                     ...
                                     <img id="avatarPreviewImage" alt="Employee photo preview"
                                         class="w-100 h-100 object-fit-cover {{ empty($photoUrl) ? 'd-none' : '' }}"
                                         src="{{ $photoUrl }}">
                                     <i class="bi bi-person-fill {{ !empty($photoUrl) ? 'd-none' : '' }}"
                                         id="avatarPlaceholderIcon" style="font-size: 3rem;"></i>

                                     <label
                                         class="avatar-upload-overlay position-absolute top-0 start-0 w-100 h-100 rounded-circle bg-dark bg-opacity-50 text-white d-flex flex-column align-items-center justify-content-center gap-1 small fw-semibold"
                                 ...
                                 <button type="button"
                                     class="btn btn-danger btn-sm position-absolute rounded-circle d-flex align-items-center justify-content-center remove-photo-btn {{ empty($photoUrl) ? 'd-none' : '' }}"
                                     id="removePhotoBtn"
                                     style="top: 5px; right: 5px; width: 18px; height: 18px; z-index: 10; padding: 0;"
                                     title="Delete Photo">
                     ...
                     <div class="card border-0 shadow-sm bg-light">
                         <div class="card-body p-3">
                             ...
                             <div class="row g-3 w-100">
                                 ...
                                 <div class="col-md-4">
                                     <label class="form-label">Ex Employment<span class="text-danger">*</span></label>
                                     <div class="d-flex flex-wrap gap-2">
                                         ...
                                         <input class="btn-check" type="checkbox" name="is_father_deceased"
                                             id="giFatherDeceasedCheckbox" value="1"
                                             {{ $employee->is_father_deceased ?? false ? 'checked' : '' }}>
                                         <label class="btn btn-outline-secondary rounded-pill px-3 py-1"
                                             for="giFatherDeceasedCheckbox">Father Deceased</label>
                                     </div>
                                 </div>

                                 <div class="col-md-4">
                                     <label class="form-label">CNIC <span class="text-danger">*</span></label>
                                     <input type="text" name="cnic" class="form-control cnic-mask"
                                         id="giCnicInput" value="{{ $employee->cnic ?? '' }}"
                                 ...
                                 <div class="col">
                                     ...
                                     <input type="date" name="cnic_expiry" class="form-control"
                                         value="{{ isset($employee->cnic_expiry) && $employee->cnic_expiry ? (is_string($employee->cnic_expiry) ? date('Y-m-d', strtotime($employee->cnic_expiry)) : $employee->cnic_expiry->format('Y-m-d')) : '' }}"
                                         placeholder="yyyy-mm-dd">
                                 </div>
                                 <div class="col" id="giFatherCnicField">
                                     <label class="form-label">Father CNIC <span class="text-danger">*</span></label>
                                     <input type="text" name="father_cnic" class="form-control cnic-mask"
                                         id="giFatherCnicInput" value="{{ $employee->father_cnic ?? '' }}"
                                         placeholder="00000-0000000-0">
                                 </div>
                                 <div class="col">
                                     <label class="form-label">NTN #</label>
                                     <input type="text" name="ntn" class="form-control"
                                         value="{{ $employee->ntn ?? '' }}" placeholder="Enter NTN number">
                                 </div>
                             </div>
                         </div>
                     </div>
                             ...
                             <div class="row g-3">
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <input type="text" name="city_of_birth" class="form-control"
                                         value="{{ $employee->city_of_birth ?? '' }}"
                                         placeholder="Enter town or city">
                                 </div>
                                 <div class="col-md-6">
                                     <label class="form-label">Nationality <span class="text-danger">*</span></label>
                                     <select name="nationality" class="form-select location-select"
                                         id="giNationalityInput" data-type="country"
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <select name="gender" class="form-select" id="giGenderInput">
                                         <option value="" {{ !isset($employee->gender) ? 'selected' : '' }}
                                             disabled>--
                                             Select --</option>
                                         <option value="Male"
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <select name="domicile_province" class="form-select location-select"
                                         id="giProvinceSelect" data-type="province"
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <select name="domicile_district" class="form-select location-select"
                                         id="giDistrictSelect" data-type="district"
                             ...
                             <div class="row g-3">
                                 <div class="col-md-6">
                                     ...
                                     <select name="religion" class="form-select" id="giReligionInput">
                                         <option value="" {{ !isset($employee->religion) ? 'selected' : '' }}
                                             disabled>--
                                             Select --</option>
                                         <option value="Islam"
                                             {{ ($employee->religion ?? '') == 'Islam' ? 'selected' : '' }}>
                                             Islam</option>
                                         <option value="Hinduism"
                                             {{ ($employee->religion ?? '') == 'Hinduism' ? 'selected' : '' }}>
                                             Hinduism</option>
                                         <option value="Christianity"
                                             {{ ($employee->religion ?? '') == 'Christianity' ? 'selected' : '' }}>
                                             Christianity</option>
                                         <option value="Sikhism"
                                             {{ ($employee->religion ?? '') == 'Sikhism' ? 'selected' : '' }}>
                                             Sikhism</option>
                                         <option value="Other"
                                             {{ ($employee->religion ?? '') == 'Other' ? 'selected' : '' }}>
                                             Other</option>
                                     </select>
                                 </div>
                                 <div class="col-md-6">
                                     ...
                                     <input type="text" name="sect" class="form-control"
                                         value="{{ $employee->sect ?? '' }}" placeholder="Enter sect">
                                 </div>
                                 <div class="col-md-6">
                                     ...
                                     <select name="marital_status" class="form-select" id="giMaritalStatusSelect">
                                         <option value=""
                                             {{ !isset($employee->marital_status) ? 'selected' : '' }} disabled>Select
                                         </option>
                                         <option value="Single"
                                 ...
                                 <div class="col-md-6 {{ ($employee->marital_status ?? '') == 'Married' ? '' : 'd-none' }}"
                                     id="giSpouseNameField">
                                     <label class="form-label">Spouse Name <span class="text-danger">*</span></label>
                                     <input type="text" name="spouse_name" class="form-control"
                                         value="{{ $employee->spouse_name ?? '' }}" placeholder="Enter spouse name">
                                 </div>
                                 <div class="col-md-6 {{ ($employee->marital_status ?? '') == 'Married' ? '' : 'd-none' }}"
                                     id="giSpouseNationalityField">
                                     <label class="form-label">Spouse Nationality <span
                                             class="text-danger">*</span></label>
                                     <select name="spouse_nationality" class="form-select location-select"
                                         id="giSpouseNationalityInput" data-type="country"
                                 ...
                                 <div class="col-md-6 {{ ($employee->marital_status ?? '') == 'Married' ? '' : 'd-none' }}"
                                     id="giSpouseCnicField">
                                     <label class="form-label">Spouse CNIC <span class="text-danger">*</span></label>
                                     <input type="text" name="spouse_cnic" class="form-control cnic-mask"
                                         value="{{ $employee->spouse_cnic ?? '' }}" placeholder="00000-0000000-0">
                                 </div>
                             </div>
                         </div>
                     </div>
