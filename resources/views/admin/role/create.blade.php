                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch mt-2">
                            ...
                            <input type="checkbox" name="is_primary" id="is_primary" class="form-check-input" value="1" {{ old('is_primary') ? 'checked' : '' }}>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (oldOrganizationId) {
            loadDepartments(oldOrganizationId, oldDepartmentId);

            if (oldDepartmentId) {
                loadParentRoles(oldOrganizationId, oldDepartmentId, oldParentRoleId);
            } else {
