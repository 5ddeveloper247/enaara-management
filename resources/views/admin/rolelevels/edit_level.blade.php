    ...
    <div class="offcanvas-body">
        <form id="editRoleLevelForm" method="POST" action="javascript:void(0);" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="edit_rl_name" name="name" placeholder="Enter role level name" maxlength="50" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="edit_rl_level" name="level" placeholder="Enter priority level (max 10 digits)" min="1" max="9999999999" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="edit_rl_description" name="description" rows="3" placeholder="Enter description" maxlength="500"></textarea>
            </div>
