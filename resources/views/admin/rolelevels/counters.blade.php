                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="flex-grow-1">
                        <h6 class="opacity-75 text-white mb-2 small fw-normal text-uppercase">
                            <i class="bi bi-layers me-1"></i>Total Role Levels
                        </h6>
                        <div class="fs-4 mb-2 fw-bold text-white" id="totalRoleLevels">{{ $totalRoleLevels ?? 0 }}</div>
                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="flex-grow-1">
                        <h6 class="text-muted mb-2 small fw-normal text-uppercase">
                            <i class="bi bi-check-circle me-1"></i>Active Levels
                        </h6>
                        <div class="fs-4 mb-2 fw-bold" id="activeRoleLevels">{{ $activeRoleLevels ?? 0 }}</div>
        ...
        <div class="card border-0 rounded-3 shadow h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="flex-grow-1">
                        <h6 class="text-muted mb-2 small fw-normal text-uppercase">
                            <i class="bi bi-x-circle me-1"></i>Inactive Levels
                        </h6>
                        <div class="fs-4 mb-2 fw-bold text-main" id="inactiveRoleLevels">{{ $inactiveRoleLevels ?? 0 }}</div>
