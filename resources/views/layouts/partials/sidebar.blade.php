        ...
        <ul class="list-unstyled mb-0">
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.dashboard.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/dashboard') ? 'active' : '' }}">
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.organization.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/organization*') ? 'active' : '' }}">
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.employee.type.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/employee-type*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.work.type.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/work-type*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
                    <span>Work Type</span>
                </a>
            </li>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.attendance.modes.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/attendance-modes*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.shift.type.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/shift-type*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.sbu.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/sbu') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
                    <span>Sbu's</span>
                </a>
            </li>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.sbu.floor.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/sbu-floor*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.department.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/department*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.leave.type.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/leave-type*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.module.category.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/module-categories*') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ route('admin.module.index') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/module') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>
                    <span>Modules</span>
                </a>
            </li>
            ...
            <li class="mb-1 mx-3">
                <a href="{{ url('/admin/roles') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/roles*') ? 'active' : '' }}">
            ...
            <li class="mb-1 mx-3">
                <a href="{{ url('/admin/monthly-logs') }}"
                    class="nav-link d-flex align-items-center text-white text-decoration-none px-3 py-2 rounded-pill {{ request()->is('admin/monthly-logs*') ? 'active' : '' }}">
